...
function default_parser_item($add_item = array())
{
    ...
    $return = array(
        'base_url'          => base_url(),
        'site_url'          => site_url(),
        'favicon_url'       => base_url('assets/images/favicon.jpg'),
        'copyright_setup'   => 'Copyright &copy; 2019 - ' . date('Y') . 'Robert Edison Weyai - <a href="http://www.dokumenary.net">dokumenary.net</a>',
    ...
    if ($CI->uri->segment(1) != 'setup') {
        $return['copyright'] = 'Copyright &copy; 2020 '. get_pengaturan('nama-sekolah', 'value').' by Robert Edison Weyai';
